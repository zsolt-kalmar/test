...
public class TransactionBuyMulti extends TransactionBuy {

    @Override
    public String process(Inventory inventory, String... params) throws BadParameterException {
        if ((params.length - 1) % 2 != 0) {
            throw new BadParameterException("Invalid numer of arguments. MULTIBUY must have even number of parameters: (isbn,quantity),...");
        }
    ...
    public TransactionType getType() {
        return TransactionType.MULTIBUY;
    }
}